-- =====================================================
-- Real Estate Hotspot - Complete Database Setup
-- =====================================================
...
INSERT INTO real_estate_agents (id, agency_name, license_number, phone, bio, verification_status, rating, total_reviews, years_experience, specializations) VALUES
...
INSERT INTO properties (id, title, description, property_type, listing_type, status, price, bedrooms, bathrooms, area_sqm, address, city, state, agent_id, featured, verified, images, amenities, year_built, parking_spaces, furnishing_status, seo_slug) VALUES
...
-- =====================================================
-- Uncomment the following lines if you want real-time subscriptions
